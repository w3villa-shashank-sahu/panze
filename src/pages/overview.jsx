...
function OverviewPage() {
  ...
  return (
    ...
    <div className="min-h-full overflow-y-scroll scrollbar-hide gap-4 flex  w-full flex-col  justify-start ">
      <div className="text-gray-400 flex items-center" style={{fontSize: "clamp(14px, 2vw, 18px"}}>
        Dashboard <ChevronRight size={"clamp(14px, 2vw, 18px)"}  /> Overview
      </div>
      <div className="flex flex-wrap gap-4 justify-center ">
        <TaskCard
          ...
          avatars={[
            "https://img.freepik.com/free-vector/isolated-young-handsome-man-different-poses-white-background-illustration_632498-859.jpg?t=st=1739792098~exp=1739795698~hmac=5c3853aa8204cef7cefbe20580f43273f8ecee770b80ac8c86f3e90f611c437f&w=826",
            "https://img.freepik.com/free-vector/isolated-young-handsome-man-different-poses-white-background-illustration_632498-859.jpg?t=st=1739792098~exp=1739795698~hmac=5c3853aa8204cef7cefbe20580f43273f8ecee770b80ac8c86f3e90f611c437f&w=826",
          ]}
        />
        <TaskCard
      ...
      <div className="flex w-full flex-col items-center justify-center gap-4 xl:flex-row  box-border">
        <PieChart />
        <ProjectStatistics />
      </div>
      <div className="flex flex-wrap gap-4 max-h-[500px] justify-center">
        ...
        <div className="flex flex-col gap-4 justify-center flex-1 min-w-74 bg-white rounded-lg p-3">
          {taskData.map((task, index) => (
            <DailyTaskCard key={index} {...task} />
          ))}
        </div>
      </div>
      {/* <div className="h-[400px] w-full bg-slate-600">hhjhhjjhjh</div> */}
